                  ...
                  <div class="row">
                    ...
                    <form action="profile_update.php" method="POST" enctype="multipart/form-data">
                      <div class="row g-3">
                        ...
                        <!-- <div class="col-12">
                          <label for="fandom" class="form-label">Profile Picture</label>
                          <input type="file" class="form-control" id="image" name="image" placeholder="" value="" required="" fdprocessedid="khla5h">
                          <div class="invalid-feedback">
                            Valid fandom is required.
                          </div>
                        </div> -->
