...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="border-bottom: 2px solid #7C924E; background-color: white;">
    ...
    <div class="container" style="margin-top: 75px; margin-bottom: 50px;">
        <div class="row">
            <div class="col6 Word">
            <h1 class="pb-2 border-bottom" style="font-weight: bold;">ABOUT US</h1>
            </div>
        </div>
        ...
        <div class="row row-cols-2" style= "font-family:sans-serif; margin-bottom: 75px;">
            ...
            <div class="col-6 keterangan" style="margin-left: 40px; text-align: justify; font-family: sans-serif; display: inline-block; padding : 10px;">
                <h2 style="font-size: 30px; font-weight: bold; text-align: center; margin-bottom: 20px;">What is O-KI?</h2>
                ...
                <p style="color: #7C924E;"><b>VISION</b></p>
                <p>To be the best website for people to read and understand the K-POP news without need to browse from sosial media.</p>
                <p style="color: #7C924E;"><b>MISSION</b></p>
                <p>To be the number one website for sharing K-POP updated news.</p>
            </div>
        </div>

        <div class="row" style="font-family:sans-serif;">
            <div class="col6 contact"  style="padding-left: 15px;">
            <h1 class="pb-2 border-bottom" style="font-weight: bold; margin-bottom: 30px;">CONTACT US</h1>
              <ul>
                  <li style="font-size: medium; margin-bottom: 10px;">Email: <a href="">O-KI@gmail.com</a></li>
                  <li style="font-size: medium; margin-bottom: 10px;">Phone: <a href="">(+62) 853-1234-5678</a></li>
        ...
        <div class="row" style="font-family:sans-serif; margin-top: 75px; margin-bottom: 20px;">
            <div class="col9 note" style="padding-left: 15px;">
                <h1 class="pb-2 border-bottom" style="font-weight: bold; margin-bottom: 30px;">NOTE</h1>
    ...
    <!-- Footer -->
    <div class="container">
      <div style="margin: 70px 0 15px 550px;">
