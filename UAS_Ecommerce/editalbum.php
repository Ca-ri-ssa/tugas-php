        ...
        <div class="main-body">
            ...
            <div class="editalbum">
              ...
              <form action="" method="POST" enctype="multipart/form-data">
                  Nama:  <input type="text" name="NewTitle" placeholder="Nama Album"  value="<?php echo $data2->Title ?>" width= "600px" size="50" ><br/>
                  Gambar: <img src="data:image/png;base64,<?php echo base64_encode($oldimage) ?>" width="400px" height="230px" border="2px solid black"><br/>
                  <input type="file" name="Newimage" placeholder="Gambar Album"><br/>
                  Harga: <input type="text" name="harga" placeholder="Harga Album"  value="<?php echo $data2->harga ?>" width= "600px" size="50" ><br/>
                  <!-- Keterangan: <br/> <textarea name="deskripsi" placeholder="Deskripsi Album"  value="<?php echo $data2->deskripsi?>"></textarea><br/> -->
                  Keterangan: <br/> <textarea id="deskripsi" name="deskripsi" placeholder="Deskripsi Album"> <?php echo $data2->deskripsi?></textarea><br/>
