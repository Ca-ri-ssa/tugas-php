...
<body>
  ...
  <div class="container-fluid" style="margin: 80px 0 20px 0; padding: 0 100px; border-bottom: 2px solid #7C924E">
    ...
    <div style="text-align: right; margin-bottom: 30px;">
        ...
        <button onclick="location.href='edit_news.php?id_news=<?php echo $row['id_news'] ?>'" class="btn btn-primary" name="edit" style="display: inline; margin: 0 20px 0 700px;">Edit</button>
    ...
    <img src="data:image/png;base64,<?php echo base64_encode($row['imgnews']) ?>" style="display:block; margin-left: auto; margin-right: auto; width:650px;">
    <br>
