...
<head>
    ...
    <title>Nct-Neobong Lightstick</title>
...
<body>
    ...
    <div class="container container px-4 py-5">
        <div class="row" style=" float: center;">
            <img align="middle" style="width: 700px; height: 400px; border: 1px solid grey; border-radius: 2%; background-color: rgba(225,225,199,255); display:block; margin: auto;" src="img/nct-lightstick.png">
        </div>

        <div class="row ">
            <h1 style="font-weight: bolder; font-size: 40px;">NeoBong</h1>
            <h3 style="font-weight: bold; font-size: 30px;">NCT'S Lightstick</h3>
