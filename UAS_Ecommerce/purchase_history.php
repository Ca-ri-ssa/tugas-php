    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="border-bottom: 2px solid #7C924E; background-color: white;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="purchase_history.php" style="color: #198754;">Purchase List</a>
                </li>
    ...
    <div class="container px-4 py-5" id="custom-cards">  
        ...
        <div class="col-11 fontart" style="margin: 10px 0 0 0px;">
            ...
            <div class="col-auto d-none d-lg-block">
                <img src="data:image/png;base64,<?php echo base64_encode($datapurchase['image']) ?>" class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title>
                </div>
            <div class="col p-5 d-flex flex-column position-static">
                <h3 class="mb-0"><?php echo $datapurchase['nama_barang'] ?></h3>
                <h4 class="mb-0"><?php echo $datapurchase['harga_barang'] ?></h4>
                ...
                <p class="card-text mb-auto">Status Barang: <?php echo $datapurchase['statusbarang'] ?></p>
                <br/>
        ...
        <!-- <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
            <div class="col-auto d-none d-lg-block">
                <img src="img/merchandise/lightstick/nct-lightstick.png" class="bd-placeholder-img" width="50%" height="50%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false" style="margin-top: 15%; margin-left: 50px; width: fit-content;"><title>Placeholder</title>
                </div>
            <div class="col p-5 d-flex flex-column position-static" style="margin-left: -180px; margin-top: 10%;">
                <h3 class="mb-4">NCT NeoBong Lightstick</h3>
                <p class="card-text mb-auto">Rp 650.000</p>
            </div>
        </div> -->
