...
<body>
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto my-2 my-lg-0" style="font-size: 16px; margin-left: 6px; color: black;">
            ...
            <ul class="dropdown-menu dropdwown-menu-light" aria-labelledby="navbarDropdownNews">
                    ...
                    <li><a class="dropdown-item" href="../merchandise/merchandise.php" style="color: balck;">Merchandise</a></li>
  ...
  <div class="container-fluid" style="margin: 80px 0 20px 0; padding: 0 100px; border-bottom: 2px solid #7C924E">
    ...
    <div style="text-align: right; margin-bottom: 30px;">
      ...
      <p style="font-size: 12px; display: inline;"><?php echo ['date_news'] ?></p>
    </div>
    <img src="../../img_news/<?php echo ['image_news'] ?>" style="display:block; margin-left: auto; margin-right: auto; width:650px;">
    <br>
