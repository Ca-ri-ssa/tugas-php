                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-sm btn-outline-success"><a style="text-decoration:none; color:green" href="concert.php?idh=<?php echo $ambil['id_ticket']?>">View</a></button>
                                </div>
