<?php 
    ...
    $data = mysqli_query($conn, "SELECT * FROM ticket WHERE id_ticket = '".$_GET['id']."' ");
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="border-bottom: 2px solid #7C924E; background-color: white;">
    ...
    <div class="container" style="margin-top: 80px;">
        <div class="main-body">
            <h3 class="pb-2 border-bottom" style="margin-bottom: 50px;">Edit Ticket Concert</h3>
            <?php
              $id = $data2->id_ticket;
            ...
            <div style="padding: 0 30px;">
              <div class="col-12">
                ...
                <input type="text" name="NewTitle" class="form-control" placeholder="Nama Ticket"  value="<?php echo $data2->Title ?>">
              </div>

              <div class="col-12">
                Gambar <br/> 
                <img src="data:image/png;base64,<?php echo base64_encode($oldimage) ?>" width="400px" height="230px" border="2px solid black"><br/>
                <input class="form-control" type="file" name="Newimage" placeholder="Gambar Ticket"><br/>
              </div>
              
                Harga: <input class="form-control" type="text" name="harga" placeholder="Harga Ticket"  value="<?php echo $data2->harga ?>" width= "600px" size="50" ><br/>
            ...
            <?php
              if(isset($_POST['submit'])){
                ...
                $nama_ticket = $_FILES['Newimage']['name'];
                $size_ticket = $_FILES['Newimage']['size'];
                $tipe_ticket = $_FILES['Newimage']['type'];
                $tmp_ticket = $_FILES['Newimage']['tmp_name'];

                $gambar = addslashes(file_get_contents($tmp_ticket));
                $update = "UPDATE ticket SET Title='$title', Nama_image='$nama_ticket', image='$gambar', harga='$harga', deskripsi='$deskripsi' WHERE id_ticket=$id ";
