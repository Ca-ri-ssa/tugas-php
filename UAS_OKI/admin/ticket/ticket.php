...
<body>
    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel" style="margin-top: 60px;">
        ...
        <div class="carousel-inner" style="height: 500px;">
          <div class="carousel-item active 1">
            <svg class="bd-placeholder-img-1" width="100%" height="100%"><rect width="100%" height="100%" fill="url(../../img/ticket/header/blackpink.png)"/></svg>
              <div class="container">
          ...
          <div class="carousel-item 2">
            <svg class="bd-placeholder-img-2" width="100%" height="100%"><rect width="100%" height="100%" fill="url(../../img/ticket/header/bts.png)"/></svg>
              <div class="container">
                <div class="carousel-caption text-start" style="padding-left: 10px;">
                    <h1></h1>
                </div>
          ...
          <div class="carousel-item 3">
            <svg class="bd-placeholder-img-3" width="100%" height="100%"><rect width="100%" height="100%" fill="url(../../img/ticket/header/nct.png)"/></svg> 
              <div class="container">
                <div class="carousel-caption text-start" style="padding-left: 10px;">
                    <h1></h1>
                </div>
    ...
    <div class="container">
        ...
        <div class="container px-4 py-5" id="custom-cards">
            <h2 class="pb-2 border-bottom" style="font-weight: bold;">Ticket Concert <a style="font-weight:bold; float: right; color: #7C924E; font-size: 18px; padding-top: 12px; text-decoration:none" href="tambahconcert.php">+concert</a></h2>
            <div class="ticket-kategori">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3" style="margin-top: 45px; margin-bottom: 20px;">
                    <?php
                        $ticket = mysqli_query($conn, "SELECT * FROM ticket ORDER BY id_ticket DESC");
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-success"><a style="text-decoration:none; color:green" href="concert.php?idh=<?php echo $ambil['id_ticket']?>">View</button>
    ...
    <!-- <div class="container">
        <form class="d-flex" role="search" style="margin: 30px 0 10px;">
            <input class="form-control me-2" type="search" placeholder="Search merchandise" aria-label="Search">
            <button class="btn btn-success" type="submit" style="background-color: #7C924E; border: 1px solid #7C924E;">Search</button>
        </form>
        <div class="container px-4 py-5" id="custom-cards">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3" style="margin-top: 45px; margin-bottom: 20px;">
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="img/ticket/Concert/Agust_D_Concert.jpg" class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                        <div class="card-body">
                            <h4 class="card-text" style="text-align: center; margin: 20px 0 30px 0;">Agust D Concert in ICE BSD</h4>
                            <div class="d-flex justify-content-between align-items-center">
                                <select class="form-select form-select-sm" style="border: 1px solid green; color: green; width: 54%;" name="seating" id="seating">
                                ...
                                <!-- <div class="btn-group">
                                    <button class="btn btn-sm btn-outline-success dropdown-toggle" type="button" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">
                                        Seating
                                    </button>
                                    <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" >VIP</a></li>
                                    <li><a class="dropdown-item">CAT 1</a></li>
                                    <li><a class="dropdown-item">CAT 2</a></li>
                                    <li><a class="dropdown-item">CAT 3</a></li>
                                    <li><a class="dropdown-item">CAT 4</a></li>
                                    <li><a class="dropdown-item">CAT 5</a></li>
                                    </ul>
                                </div> -->
                                <!-- <div class="btn-group">
                                    <button type="button" class="btn btn-sm btn-outline-success"><a style="text-decoration:none; color: green" href="Agust_D.html">Next</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="img/ticket/Concert/Born_Pink_Concert.png" class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                        <div class="card-body">
                            <h4 class="card-text" style="text-align: center; margin: 20px 0 30px 0;">Blackpink in GBK</h4>
                            <div class="d-flex justify-content-between align-items-center">
                                <select class="form-select form-select-sm" style="border: 1px solid green; color: green; width: 54%;" name="seating" id="seating">
                                    <option>Seating</option>
                                    <option value="VIP">VIP</option>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-sm btn-outline-success"><a style="text-decoration:none; color: green" href="">Next</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="img/ticket/Concert/Checkmate_Concert.png" class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                        <div class="card-body">
                            <h4 class="card-text" style="text-align: center; margin: 20px 0 30px 0;">ITZY in Tennis Indoor Senayan</h4>
                            <div class="d-flex justify-content-between align-items-center">
                                <select class="form-select form-select-sm" style="border: 1px solid green; color: green; width: 54%;" name="seating" id="seating">
                                    <option>Seating</option>
                                    <option value="VIP">VIP</option>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3" style="margin-top: 45px; margin-bottom: 20px;">
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="img/ticket/Concert/Hello_Concert.png" class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                        <div class="card-body">
                            <h4 class="card-text" style="text-align: center; margin: 20px 0 30px 0;">Treasure Concert in ICE BSD</h4>
                            <div class="d-flex justify-content-between align-items-center">
                                <select class="form-select form-select-sm" style="border: 1px solid green; color: green; width: 54%;" name="seating" id="seating">
                                    <option>Seating</option>
                                    <option value="VIP">VIP</option>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="img/ticket/Concert/TDS2_Concert.png" class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                        <div class="card-body">
                            <h4 class="card-text" style="text-align: center; margin: 20px 0 30px 0;">Nct Dream Concert in ICE BSD</h4>
                            <div class="d-flex justify-content-between align-items-center">
                                <select class="form-select form-select-sm" style="border: 1px solid green; color: green; width: 54%;" name="seating" id="seating">
                                    <option>Seating</option>
                                    <option value="VIP">VIP</option>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <img src="img/ticket/Concert/Viviz_Concert.png" class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                        <div class="card-body">
                            <h4 class="card-text" style="text-align: center; margin: 20px 0 30px 0;">Viviz Concert in Sutera Hall</h4>
                            <div class="d-flex justify-content-between align-items-center">
                                <select class="form-select form-select-sm" style="border: 1px solid green; color: green; width: 54%;" name="seating" id="seating">
                                    <option>Seating</option>
                                    <option value="VIP">VIP</option>
