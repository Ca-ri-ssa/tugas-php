...
<body style="overflow-x: hidden;">
  ...
  <section class="News">
    <div class="container" id="product-cards">
      ...
      <div class="pb-2 border-bottom">
        ...
        <button onclick="location.href='../news/add_news.php'" class="btn btn-success" style="display: inline; float: right;">ADD</a>
      </div>
      ...
      <div class="container px-4 py-5" id="custom-cards">
        ...
        <div class="col-11 fontart" style="margin: 55px 0 0 0px;">
          <?php
          ...
          <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
            <div class="col-auto d-none d-lg-block">
                <img src="data:image/png;base64,<?php echo base64_encode($datatop['image']) ?>" class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title>
                </div>
            <div class="col p-5 d-flex flex-column position-static">
                ...
                <br/>
                <button onclick="location.href='edittop.php?id=<?php echo $datatop['id_top']?>'" class="btn btn-success" style="display: inline; float: right; width:80px">Edit</a>
            </div>
          </div>
          <?php } ?>
        </div>
  ...
  <div div class="row" style="margin-top: 100px; background-color: #DBE2CD;">
      <div class="pb-2 border-bottom" style="margin-top: 30px">
        <h2 style="margin: 20px 0px 10px 55px; font-weight: bold; display: inline;">Recommendation</h2>
        <button onclick="location.href='add_home_recom.php'" class="btn btn-success" style="margin-right: 55px; display: inline; float: right;">ADD</a>
      </div>
