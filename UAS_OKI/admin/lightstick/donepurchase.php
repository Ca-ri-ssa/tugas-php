...
<head>
  ...
  <link href="../../bootstrap/bootstrap-5.2.3-examples/assets/dist/css/bootstrap.min.css" rel="stylesheet"><title>Purchase</title>
...
<body>
    <!-- Navbar -->
        ...
        <div class="container px-4 py-5" id="custom-cards" style="width: fit-content;">
            ...
            <p style="text-align: center">You can also contact us here: <a href="../contact_us/contact_us.php">Contact Us Here!</a></p>
            ...
            <a class="btn btn-success" href="../home/homepage.php" role="button" style="padding-left: 30%; padding-right:30% ;">Done</a>
        </div>
