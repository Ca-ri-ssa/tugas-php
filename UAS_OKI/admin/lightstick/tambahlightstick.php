...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="border-bottom: 2px solid #7C924E; background-color: white;">
    ...
    <div class="container" style="margin-top: 75px; margin-bottom: 50px;">
        <div class="main-body">
            <h1 class="pb-2 border-bottom" style="font-weight: bold; margin-bottom: 20px;">Tambah Lightstick</h1>
            <div class="tambahanlightstick">
                <form action="" method="POST" enctype="multipart/form-data">
                    Nama:  <input type="text" name="Title" placeholder="Nama Lightstick"  value="" width= "600px" size="50" required><br/>
                    Gambar: <input type="file" name="image" placeholder="Gambar Lightstick" value="Upload"  required><br/>
                    Harga: <input type="text" name="harga" placeholder="Harga Lightstick"  value="" width= "600px" size="50" required><br/>
                    Keterangan: </br> <textarea name="deskripsi" placeholder="Deskripsi Lightstick"  value="keterangan" required></textarea><br/>
