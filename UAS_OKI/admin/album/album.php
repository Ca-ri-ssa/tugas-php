        ...
        <nav class="navbar navbar-expand-lg navcolor" style="border-bottom: 2px solid #7C924E;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <button onclick="location.href='../hapus/hapusalbum.php?idm=<?php echo $data2->id_album ?>'" class="btn btn-danger" name="delete" style="display: inline; margin: 0 20px 0 10px;">Delete</button>
                </div>
            </div>
        </nav>
