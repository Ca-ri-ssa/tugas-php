    ...
    <body class="text-center">
        <main class="form-signin w-25 m-auto">
          <form>
            ...
            <h1 class="h3 mb-5 fw-bold fontsign">Please sign in</h1>
            ...
            <p>Do you have an account? <a href="log_in.php">Log in</a></p>
            <button class="w-50 btn btn-success" type="submit" style="margin-bottom: 80px;">Sign in</button>
          </form>
        </main>
    </body>
</html>