...
<meta charset="UTF-8" />
  ...
  <link href="bootstrap/bootstrap-5.2.3-examples/assets/dist/css/bootstrap.min.css" rel="stylesheet"><title>Profile</title>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                      <img src="img/profilepic.png" class="rounded" alt="..." width="300px" style="margin-top: 30px;">
                      <div class="data" style="margin-top: 30px; margin-bottom: 30px;">
                        <h4 value="" name="">Markonah</h4>
                        <p class="text-secondary mb-1">Certified Army</p>
                        <p class="text-muted font-size-sm">Bay Area, San Francisco, CA</p>
                        <div style="margin-top: 30px;">
                          <button class="btn btn-outline-success" style="margin-right: 10px;">Edit</button>
                    ...
                    <form class="needs-validation" novalidate="">
                      <div class="row g-3">
                        <div class="col-sm-6">
                          ...
                          <input type="text" class="form-control" id="firstName" placeholder="" value="" required="" fdprocessedid="yflgl">
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="text" class="form-control" id="lastName" placeholder="" value="" required="" fdprocessedid="khla5h">
                          <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                          ...
                          <div class="input-group has-validation">
                            ...
                            <input type="text" class="form-control" id="username" placeholder="Username" required="" fdprocessedid="3eviec">
                            <div class="invalid-feedback"> 
                        ...
                        <div class="col-12">
                          ...
                          <div class="input-group has-validation">
                            ...
                            <input type="text" class="form-control" id="phone" placeholder="Phone Number" required="" fdprocessedid="3eviec">
                            <div class="invalid-feedback"> 
                        ...
                        <div class="col-12">
                          ...
                          <input type="email" class="form-control" id="email" placeholder="you@example.com" fdprocessedid="l7js95">
                          <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                          ...
                          <input type="text" class="form-control" id="address" placeholder="Jl Imam Bonjol" required="" fdprocessedid="ugyswp">
                          <div class="invalid-feedback">
                        ...
                        <div class="col-12">
                          ...
                          <input type="text" class="form-control" id="fandom" placeholder="Fandom name" value="" required="" fdprocessedid="khla5h">
                          <div class="invalid-feedback">
