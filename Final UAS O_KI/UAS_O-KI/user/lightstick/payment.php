<?php
    ...
    $data = mysqli_query($conn, "SELECT * FROM lightstick WHERE id_lightstick = '".$_GET['idp']."' ");
          ...
          <div class="row g-5">
            ...
            <form class="needs-validation" novalidate="" method="POST" action="">
              <div class="row g-3">
                ...
                <input type="hidden" style="display-none" name="image" placeholder="Gambar Lightstick" value=""><br/>
                ...
                <input type="hidden" name="status" placeholder="Nama Lightstick"  value="<?php echo $status_data ?>" width= "600px" size="50" required><br/>
            ...
            <?php
              if(isset($_POST['submit'])){
                ...
                if ($bisa) {
                  header("Location: donepurchase.php?id= $data2->id_lightstick");
                  exit();
                } else {
