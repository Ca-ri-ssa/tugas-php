                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-success"><a style="text-decoration:none; color:green" href="../photocard/photocard.php?idh=<?php echo $ambil['id_photocard']?>">View</a></button>
                                    </div>
                                    <large class="text-muted">Rp <?php echo $ambil['harga'] ?></large>
                                </div>
                            </div>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-success"><a style="text-decoration:none; color:green" href="../lightstick/lightstick.php?idh=<?php echo $ambil['id_lightstick']?>">View</a></button>
                                    </div>
                                    <large class="text-muted">Rp <?php echo $ambil['harga'] ?></large>
                                </div>
                            </div>
