  ...
  <main class="container" style="border: 2px solid lightgray; width: 70%;box-shadow: 2px 2px 5px #0011; margin: 80px 0 70px 200px; padding: 30px;">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-2 mb-3 border-bottom">
      ...
      <h2 style="text-align: center; margin-bottom: 20px;"><?php echo $hasil['title_allnewsbanner'] ?></h2>
        ...
        <button type="hidden" class="btn btn-primary" name="edit_allnewsbanner" style="display: inline; margin: 0 20px 0 420px; background-color:transparent; border-style: none;"></button>
        <button type="hidden" class="btn btn-danger" name="delete" style="display: inline; margin: 0 20px 0 0; background-color:transparent; border-style: none;"></button>
