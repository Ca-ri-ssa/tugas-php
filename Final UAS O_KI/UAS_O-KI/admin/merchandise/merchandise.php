                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <large class="text-muted">Rp <?php echo $ambil['harga'] ?></large>
                                    <!-- <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-success"><a style="text-decoration:none; color:green" onclick="del_merchpc()">Delete</a></button>
                                        <script>
                                        function del_merchpc() {
                                                if (confirm("Are you sure to delete this photocard?")) {
                                                window.location.href='../hapus/hapusalbum.php?idp=<?php echo $ambil['id_photocard']?>';
                                                } else {
                                                window.location.href='';
                                                }
                                            }
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <large class="text-muted">Rp <?php echo $ambil['harga'] ?></large>
                                    <!-- <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-success"><a style="text-decoration:none; color:green" onclick="del_merchlightstick()">Delete</a></button>
                                        <script>
                                        function del_merchlightstick() {
                                                if (confirm("Are you sure to delete this lightstick?")) {
                                                window.location.href='../hapus/hapusalbum.php?idl=<?php echo $ambil['id_lightstick']?>';
                                                } else {
                                                window.location.href='';
                                                }
                                            }
