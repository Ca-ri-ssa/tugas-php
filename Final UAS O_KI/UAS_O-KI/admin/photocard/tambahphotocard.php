            ...
            <div class="tambahanphotocard">
                <form action="" method="POST" enctype="multipart/form-data">
                  <div style="padding: 0 30px;">
                    <div class="col-12">
                        <label for="Title" class="form-label">Photocard Name</label>
                        <input type="text" class="form-control" id="Title" name="Title" placeholder="" value="" dprocessedid="l7js95">
                    </div>
                  
                    <div class="col-12" style="margin-top: 30px;">
                        <label for="image" class="form-label" style="display: block;">Photocard Picture</label>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        $nama_photocard = $_FILES['image']['name'];
                        $size_photocard = $_FILES['image']['size'];
                        $tipe_photocard = $_FILES['image']['type'];
                        $tmp_photocard = $_FILES['image']['tmp_name'];

                        $gambar = file_get_contents($tmp_photocard);
                        $gambar = mysqli_real_escape_string($conn, $gambar);

                        $simpan = "INSERT INTO photocard VALUES (null, '".$title."', '".$nama_photocard."', '".$gambar."', '".$harga."', '".$deskripsi."')";
