        ...
        <nav class="navbar navbar-expand-lg navcolor" style="border-bottom: 2px solid #7C924E;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <button onclick="location.href='editphotocard.php?id=<?php echo $data2->id_photocard ?>'" class="btn btn-primary" name="edit" style="display: inline; margin: 0 10px 0 20px;">Edit</button>
                    <button onclick="del_pc()" class="btn btn-danger" name="delete" style="display: inline; margin: 0 20px 0 10px;">Delete</button>
                    <script>
                    function del_pc() {
                            if (confirm("Are you sure to delete this photocard?")) {
                            window.location.href='../hapus/hapusalbum.php?idp=<?php echo $data2->id_photocard ?>';
                            } else {
                            window.location.href='';
                            }
                        }
