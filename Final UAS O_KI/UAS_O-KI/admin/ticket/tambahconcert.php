...
<meta charset="UTF-8" />
  ...
  <title>Tambah Ticket Concert</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="border-bottom: 2px solid #7C924E; background-color: white;">
    ...
    <div class="container" style="margin-top: 75px; margin-bottom: 50px;">
        <div class="main-body">
            <h1 class="pb-2 border-bottom" style="font-weight: bold; margin-bottom: 20px;">Tambah Ticket Concert</h1>
            <div class="tambahanticket">
                <form action="" method="POST" enctype="multipart/form-data">
                  <div style="padding: 0 30px;">
                    ...
                    <div class="col-12" style="margin-top: 30px;">
                        <label for="image" class="form-label" style="display: block;">Ticket Picture</label>
                    ...
                    <div class="col-12" style="margin-top: 30px;">
                        <label for="deskripsi" class="form-label">Ticket Description</label>
                ...
                ``</div>
                    ...
                    <!-- Nama:  <input type="text" name="Title" placeholder="Nama Ticket"  value="" width= "600px" size="50" required><br/>
                    Gambar: <input type="file" name="image" placeholder="Gambar Ticket" value="Upload"  required><br/>
                    Harga: <input type="text" name="harga" placeholder="Harga Ticket"  value="" width= "600px" size="50" required><br/>
                    Keterangan: </br> <textarea name="deskripsi" placeholder="Deskripsi Ticket"  value="keterangan" required></textarea><br/>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        $nama_ticket = $_FILES['image']['name'];
                        $size_ticket = $_FILES['image']['size'];
                        $tipe_ticket = $_FILES['image']['type'];
                        $tmp_ticket = $_FILES['image']['tmp_name'];

                        $gambar = file_get_contents($tmp_ticket);
                        $gambar = mysqli_real_escape_string($conn, $gambar);

                        $simpan = "INSERT INTO ticket VALUES (null, '".$title."', '".$nama_ticket."', '".$gambar."', '".$harga."', '".$deskripsi."')";
