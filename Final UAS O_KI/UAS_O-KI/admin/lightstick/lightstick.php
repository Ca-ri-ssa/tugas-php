<?php 
    ...
    $data = mysqli_query($conn, "SELECT * FROM lightstick WHERE id_lightstick = '".$_GET['idh']."' ");
      ...
      <div class="main-body">
        ...
        <nav class="navbar navbar-expand-lg navcolor" style="border-bottom: 2px solid #7C924E;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <button onclick="location.href='editlightstick.php?id=<?php echo $data2->id_lightstick ?>'" class="btn btn-primary" name="edit" style="display: inline; margin: 0 10px 0 20px;">Edit</button>
                    <button onclick="del_lightstick()" class="btn btn-danger" name="delete" style="display: inline; margin: 0 20px 0 10px;">Delete</button>
                    <script>
                    function del_lightstick() {
                            if (confirm("Are you sure to delete this lightstick?")) {
                            window.location.href='../hapus/hapusalbum.php?idl=<?php echo $data2->id_lightstick ?>';
                            } else {
                            window.location.href='';
                            }
                        }
        ...
        <div class="container container px-4 py-5">
          ...
          <div class="row ">
              ...
              <h3 style="font-weight: bold; font-size: 30px;">Lightstick</h3>
          ...
          <div class="row" style="font-size: 20px;">
              ...
              <form action="payment.php" method= "GET">
                  ...
                  <?php
                      ...
                      $ambil = mysqli_fetch_array($lightstick);
                  ?>
                  <button type="button" class="btn btn-sm" style="background-color:#7C924E; color:white; font-size:20px; width: 150px; height: 50px; margin-bottom: 30px" onclick="window.location.href='payment.php?idp=<?php echo $data2->id_lightstick ?>&Quantity='+document.getElementById('Quantity').value;">Buy</button>
              </form>
