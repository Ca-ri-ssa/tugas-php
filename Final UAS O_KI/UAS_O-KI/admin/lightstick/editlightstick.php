<?php 
    ...
    $data = mysqli_query($conn, "SELECT * FROM lightstick WHERE id_lightstick = '".$_GET['id']."' ");
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="border-bottom: 2px solid #7C924E; background-color: white;">
    ...
    <div class="container" style="margin-top: 75px; margin-bottom: 50px;">
        <div class="main-body">
            <h1 class="pb-2 border-bottom" style="font-weight: bold; margin-bottom: 20px;">Edit Lightstick</h1>
            <div class="editlightstick">
              <?php
                $id = $data2->id_lightstick;
                $lightstick = mysqli_query($conn, "SELECT image FROM lightstick WHERE id_lightstick = $id");
                $ambil = mysqli_fetch_assoc($lightstick);
              ...
              <form action="" method="POST" enctype="multipart/form-data">
                <div style="padding: 0 30px;">
                  <div class="col-12">
                      <label for="NewTitle" class="form-label">Lightstick Name</label>
                  ...
                  <div class="col-12" style="margin-top: 30px;">
                      <label for="Newimage" class="form-label" style="display: block;">Lightstick Picture</label>
            ...
            ``  </div>
                  ...
                  <!-- Nama:  <input type="text" name="NewTitle" placeholder="Nama Lightstick"  value="<?php echo $data2->Title ?>" width= "600px" size="50" ><br/>
                  Gambar: <img src="data:image/png;base64,<?php echo base64_encode($oldimage) ?>" width="400px" height="230px" border="2px solid black"><br/>
                  <input type="file" name="Newimage" placeholder="Gambar Lightstick"><br/>
                  Harga: <input type="text" name="harga" placeholder="Harga Lightstick"  value="<?php echo $data2->harga ?>" width= "600px" size="50" ><br/>
                  Keterangan: <br/> <textarea id="deskripsi" name="deskripsi" placeholder="Deskripsi Lightstick"> <?php echo $data2->deskripsi?></textarea><br/>
              ...
              <?php
                if(isset($_POST['submit'])){
                  ...
                  $nama_lightstick = $_FILES['Newimage']['name'];
                  $size_lightstick = $_FILES['Newimage']['size'];
                  $tipe_lightstick = $_FILES['Newimage']['type'];
                  $tmp_lightstick = $_FILES['Newimage']['tmp_name'];

                  $gambar = addslashes(file_get_contents($tmp_lightstick));
                  $update = "UPDATE lightstick SET Title='$title', Nama_image='$nama_lightstick', image='$gambar', harga='$harga', deskripsi='$deskripsi' WHERE id_lightstick=$id ";
