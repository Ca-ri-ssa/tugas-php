          ...
          <div class="col">
              <div class="card shadow-sm">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                          <button type="button" class="btn btn-sm btn-outline-success"><a style="text-decoration:none; color:green" href="user_no_login/ticket/concert.php?idh=<?php echo $ambil['id_album']?>">View</a></button>
                        </div>
                        <large class="text-muted">Rp <?php echo $ambil['harga'] ?></large>
                    </div>
                  </div>
