...
<body style="overflow-x: hidden;">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav ms-auto my-2 my-lg-0" style="font-size: 16px; margin-left: 6px; color: black;">
          <li class="nav-item">
            <a class="nav-link active"  aria-current="page" href="index.php"><span style="color: #198754;">Home</span></a>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdwown-menu-light" aria-labelledby="navbarDropdownNews">
              <li><a class="dropdown-item" href="user_no_login/news/all_news.php" style="color: black;">News</a></li>
              <li><a class="dropdown-item" href="user_no_login/merchandise/merchandise.php" style="color: black;">Merchandise</a></li>
              <li><a class="dropdown-item" href="user_no_login/ticket/ticket.php" style="color: black;">Ticket Concert</a></li>
            </ul>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="user_no_login/purchase/purchase_history.php" style="color: black;">Purchase List</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="user_no_login/about_us/about_us.php" style="color: black;">About Us</a>
          </li>
                  
          <li class="nav-item">
            <a class="nav-link" href="user_no_login/profile/profile.php" style="color: black;">Profile</a>
          </li>
  ...
  <section class="News">
    <div class="container" id="product-cards">
            ...
            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('data:image/png;base64,<?php echo base64_encode($row['imgnews']) ?>');">
              <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">
                  <a href="user_no_login/news/read_news.php?id_news=<?php echo $row['id_news'] ?>" name="read" style="text-decoration: none; color: white"><?php echo $row['title'] ?></a>
                </h3>
      ...
      <a href="user_no_login/news/all_news.php">see more...</a>
    </div>
      ...
      <div class="container px-4 py-5" id="custom-cards">
              ...
              <div class="card shadow-sm">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                          <button type="button" class="btn btn-sm btn-outline-success"><a style="text-decoration:none; color:green" href="user_no_login/album/album.php?idh=<?php echo $ambil['id_album']?>">View</a></button>
                        </div>
        ...
        <a href="user_no_login/merchandise/merchandise.php">see more...</a>
      </div>
      ...
      <div class="container px-4 py-5" id="custom-cards">
          ...
          <div class="col">
              <div class="card shadow-sm">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                          <button type="button" class="btn btn-sm btn-outline-success"><a style="text-decoration:none; color:green" href="user_no_login/ticket/concert.php?idh=<?php echo $ambil['id_ticket']?>">View</a></button>
                        </div>
                        <large class="text-muted">Rp <?php echo $ambil['harga'] ?></large>
                    </div>
                  </div>
        ...
        <a href="user_no_login/ticket/ticket.php">see more...</a>
      </div>
      ...
      <!-- Section: Links -->
        <section class="">
            ...
            <div class="col-md-1 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p>
                <a class="text-black" href="user_no_login/news/all_news.php">News</a>
                <p>
                <a class="text-black" href="user_no_login/merchandise/merchandise.php">Merchandise</a>
                </p>
                <p>
                <a class="text-black" href="user_no_login/ticket/ticket.php">Ticket Concert</a>
                </p>
            </div>
            <!-- Grid column -->
            ...
            <div class="col-md-8 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p><i>You can also contact us here: <a href="user_no_login/contact_us/contact_us.php">Contact Us Here!</a></i></p>
            </div>
            <!-- Grid column -->
            </div>
            <!--Grid row-->
